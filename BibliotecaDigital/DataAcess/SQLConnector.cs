...
namespace Biblioteca_Digital.DataAcess
{
    public class SQLConnector : IDataConnection
    {
        ...
        public List<Autor> ListarAutores()
        {
            using (IDbConnection connection = new SqlConnection(GlobalConfig.CnnString("BibliotecaDigital")))
            {
                return connection.Query<Autor>("spListarAutores", commandType: CommandType.StoredProcedure).ToList();
            }
        }
        ...
        public void AssociarLivroAutor(int idLivro, int idAutor)
        {
            using (IDbConnection connection = new SqlConnection(GlobalConfig.CnnString("BibliotecaDigital")))
            {
                ...
                p.Add("@IdLivro", idLivro);
                p.Add("@IdAutor", idAutor);
                connection.Execute("spAssociarLivroAutor", p, commandType: CommandType.StoredProcedure);
            }
        }
        ...
        public List<LivroAutor> ListarAssociacoes()
        {
            using (IDbConnection connection = new SqlConnection(GlobalConfig.CnnString("BibliotecaDigital")))
            {
                return connection.Query<LivroAutor>("spListarAssociacoes", commandType: CommandType.StoredProcedure).ToList();
            }
        }
        ...
        public void DesassociarLivroAutor(int idLivro, int idAutor)
        {
            using (IDbConnection connection =  new SqlConnection(GlobalConfig.CnnString("BibliotecaDigital")))
            {
                ...
                p.Add("@IdLivro", idLivro);
                p.Add("@IdAutor", idAutor);
                connection.Execute("spRemoverLivroAutor", p, commandType: CommandType.StoredProcedure);
            }
        }
        ...
        public List<Livro> ListarLivrosPorAutor(int idAutor)
        {
            using (IDbConnection connection = new SqlConnection(GlobalConfig.CnnString("BibliotecaDigital")))
            {
                var p = new DynamicParameters();
                p.Add("@IdAutor", idAutor); 
                return connection.Query<Livro>("spListarLivrosPorAutor", p, commandType: CommandType.StoredProcedure).ToList();
            }
        }
        ...
        public bool LivroExiste(string isbn)
        {
            using (IDbConnection connection = new SqlConnection(GlobalConfig.CnnString("BibliotecaDigital")))
            {
                var p = new DynamicParameters();
                p.Add("@ISBN", isbn);
                int total = connection.ExecuteScalar<int>("spLivroExistePorISBN", p, commandType: CommandType.StoredProcedure);
                return total > 0;
            }
        }
    }
